...
--
-- Host: localhost
-- Generation Time: Jun 24, 2012 at 12:28 PM
...
INSERT INTO `competencies` VALUES(189, 12, 0, 'Articulate and solve basic problems of form in space through line and mass.', 0, 1);
INSERT INTO `competencies` VALUES(190, 12, 0, 'Learn to layout a drawing: use sighting techniques to create object relationships on paper which relate convincingly to what is being observed.', 0, 2);
INSERT INTO `competencies` VALUES(191, 12, 0, 'Begin to control the direction of observed contour line and to control line weight as it relates to contour edge and outline.', 0, 3);
INSERT INTO `competencies` VALUES(192, 12, 0, 'Use the elements and principles of design to compose a drawing based on observation.', 0, 4);
INSERT INTO `competencies` VALUES(193, 12, 0, 'Develop ideas through the thumbnail drawing process.', 0, 5);
INSERT INTO `competencies` VALUES(194, 12, 0, 'Analyze drawings and, using acquired vocabulary, identify opportunities for improvement.', 0, 6);
INSERT INTO `competencies` VALUES(195, 12, 0, 'Be aware of the art historical context of drawing.', 0, 7);
INSERT INTO `competencies` VALUES(196, 12, 0, 'Generate drawings that convey differences in lighting and value.', 0, 8);
INSERT INTO `competencies` VALUES(197, 12, 0, 'Use basic drawing tools: pencils of varying harness, charcoal and papers.', 0, 9);
INSERT INTO `competencies` VALUES(198, 12, 0, '"See" value intervals and translate what is seen to the two-dimensional surface.', 0, 10);
INSERT INTO `competencies` VALUES(199, 12, 0, 'Generate drawings that utilize economy of line.', 0, 11);
INSERT INTO `competencies` VALUES(200, 12, 0, 'Acquire the habit of keeping a sketchbook to record drawn observations, thumbnail ideas and notes.', 0, 12);
INSERT INTO `competencies` VALUES(201, 12, 0, 'Demonstrate drawing techniques and language.', 0, 13);
INSERT INTO `competencies` VALUES(202, 12, 0, 'Demonstrate critical thinking skills.', 0, 14);
INSERT INTO `competencies` VALUES(203, 12, 0, 'Demonstrate freehand and mechanical hand drawing construction processes.', 0, 15);
INSERT INTO `competencies` VALUES(204, 13, 0, 'Understand basic database structure and design.', 0, 1);
INSERT INTO `competencies` VALUES(205, 13, 0, 'Create and manipulate online databases.', 0, 2);
INSERT INTO `competencies` VALUES(206, 13, 0, 'Understand online applications of databases.', 0, 3);
INSERT INTO `competencies` VALUES(207, 13, 0, 'Access and manipulate online databases.', 0, 4);
INSERT INTO `competencies` VALUES(208, 14, 0, 'Research a topic and formulate an effective project proposal.', 0, 1);
INSERT INTO `competencies` VALUES(209, 14, 0, 'Design, write, and present an effective project proposal.', 0, 2);
INSERT INTO `competencies` VALUES(210, 14, 0, 'Analyze, prioritize and sequence project tasks.', 0, 3);
INSERT INTO `competencies` VALUES(211, 14, 0, 'Organize project materials into information structures and interface designs.', 0, 4);
INSERT INTO `competencies` VALUES(212, 14, 0, 'Effectively prepare assets for implementation.', 0, 5);
INSERT INTO `competencies` VALUES(213, 14, 0, 'Produce an original interactive project that incorporates multimedia elements.', 0, 6);
INSERT INTO `competencies` VALUES(214, 7, 0, 'Upon successful completion of this course, the student should be able to:', 0, 1);
INSERT INTO `competencies` VALUES(215, 7, 0, 'Research technical and design needs of project.', 0, 2);
INSERT INTO `competencies` VALUES(216, 7, 0, 'Develop technical specifications for project.', 0, 3);
INSERT INTO `competencies` VALUES(217, 7, 0, 'Understand and apply principles of structural design to produce prototype project.', 0, 4);
INSERT INTO `competencies` VALUES(218, 7, 0, 'Debug and refine project based on prototype testing.', 0, 5);
INSERT INTO `competencies` VALUES(219, 7, 0, 'Effectively meet deadlines of production schedule.', 0, 6);
INSERT INTO `competencies` VALUES(220, 7, 0, 'Produce an original interactive project that incorporates multimedia elements.', 0, 7);
INSERT INTO `competencies` VALUES(221, 15, 0, 'Create a multi-user environment for online delivery', 0, 1);
INSERT INTO `competencies` VALUES(222, 15, 0, 'Apply advanced programming skills to games development.', 0, 2);
INSERT INTO `competencies` VALUES(223, 15, 0, 'Manipulate text, image, and media elements in a multi-user environment.', 0, 3);
INSERT INTO `competencies` VALUES(224, 15, 0, 'Pass variables out of an Adobe Flash movie.', 0, 4);
INSERT INTO `competencies` VALUES(225, 15, 0, 'Create an external data source for Adobe Flash movies.', 0, 5);
INSERT INTO `competencies` VALUES(226, 16, 0, 'Understand and appreciate digital animation in the continuum of traditional animation and time-based media concepts and practices.', 0, 1);
INSERT INTO `competencies` VALUES(227, 16, 0, 'Demonstrate an understanding of basic techniques of character and narrative development as applied to traditional and digital animation.', 0, 2);
INSERT INTO `competencies` VALUES(228, 16, 0, 'Demonstrate skills in preparation of digital animation for a variety of output formats.', 0, 3);
INSERT INTO `competencies` VALUES(229, 16, 0, 'Create storyboards that effectively document narrative and/or concept development.', 0, 4);
INSERT INTO `competencies` VALUES(230, 16, 0, 'Apply visual and time-based design principles to the creation of digital animation.', 0, 5);
INSERT INTO `competencies` VALUES(231, 17, 0, 'Describe the programming process', 0, 1);
INSERT INTO `competencies` VALUES(232, 17, 0, 'Perform programming fundamentals (loops, variables, conditions)', 0, 2);
INSERT INTO `competencies` VALUES(233, 17, 0, 'Use properties and controls', 0, 3);
INSERT INTO `competencies` VALUES(234, 17, 0, 'Apply object-oriented principles to interactive design ', 0, 4);
INSERT INTO `competencies` VALUES(235, 17, 0, 'Make evident debugging and troubleshooting skills as related to web scripting', 0, 5);
INSERT INTO `competencies` VALUES(236, 17, 0, 'Create an application that solves specified problems', 0, 6);
INSERT INTO `competencies` VALUES(237, 17, 0, 'Compare and contrast procedure and object oriented programming', 0, 7);
INSERT INTO `competencies` VALUES(238, 18, 0, 'Review with instructor and advisor the direction in which the student has decided to specialize the portfolio.', 0, 1);
INSERT INTO `competencies` VALUES(239, 18, 0, 'Produce professional-level productions.', 0, 2);
INSERT INTO `competencies` VALUES(240, 18, 0, 'Demonstrate ability to make a presentation of work.', 0, 3);
INSERT INTO `competencies` VALUES(241, 18, 0, 'Complete personal letterhead and business cards.', 0, 4);
INSERT INTO `competencies` VALUES(242, 18, 0, 'Attend and professionally present your completed portfolio at the portfolio showing if you are an Associate level graduate.', 0, 5);
INSERT INTO `competencies` VALUES(243, 19, 0, 'Organize artwork in a print portfolio.', 0, 1);
INSERT INTO `competencies` VALUES(244, 19, 0, 'Develop a plan that conforms to desired outcomes and can be completed within a specified time frame.', 0, 2);
INSERT INTO `competencies` VALUES(245, 19, 0, 'Analyze, prioritize, and sequence project tasks.', 0, 3);
INSERT INTO `competencies` VALUES(246, 19, 0, 'Generate a resume that reflects the individual''s most marketable skills and qualities.', 0, 4);
INSERT INTO `competencies` VALUES(247, 19, 0, 'Recognize and adhere to copyright laws governing the use of emerging technology.', 0, 5);
INSERT INTO `competencies` VALUES(248, 19, 0, 'Adhere to rules and standards of academic and intellectual integrity such as those related to plagiarism.', 0, 6);
INSERT INTO `competencies` VALUES(249, 19, 0, 'Produce an ID package - letterhead & business card.', 0, 7);
INSERT INTO `competencies` VALUES(250, 19, 0, 'Communicate effectively with prospective employers.', 0, 8);
INSERT INTO `competencies` VALUES(251, 19, 0, 'Generate a letter that helps the individual obtain a job interview.', 0, 9);
INSERT INTO `competencies` VALUES(252, 19, 0, 'Discuss the relative effectiveness of various media for different communication purposes.', 0, 10);
INSERT INTO `competencies` VALUES(253, 19, 0, 'Use the Internet to conduct career related research.', 0, 11);
INSERT INTO `competencies` VALUES(254, 19, 0, 'Conduct networking activities with pertinent industry groups, individuals, and/or associations.', 0, 12);
INSERT INTO `competencies` VALUES(255, 19, 0, 'Evaluate personal and professional skills and interests relative to their application in possible career paths and projects.', 0, 13);
INSERT INTO `competencies` VALUES(256, 19, 0, 'Develop communication skills for job interview and presentation.', 0, 14);
INSERT INTO `competencies` VALUES(257, 19, 0, 'Develop an understanding of self-promotion, bidding + estimates, taxes, and billable expenses.', 0, 15);
INSERT INTO `competencies` VALUES(258, 20, 0, 'Design layouts for a web page.', 0, 1);
INSERT INTO `competencies` VALUES(259, 20, 0, 'Successfully convert Pantone colors into web colors.', 0, 2);
INSERT INTO `competencies` VALUES(260, 20, 0, 'Develop logically-structured web pages in Dreamweaver or similar program.', 0, 3);
INSERT INTO `competencies` VALUES(261, 20, 0, 'Identify the essential elements of successful page navigation.', 0, 4);
INSERT INTO `competencies` VALUES(262, 20, 0, 'Create workable links between portions of a page.', 0, 5);
INSERT INTO `competencies` VALUES(263, 20, 0, 'Animate graphical content.', 0, 6);
INSERT INTO `competencies` VALUES(264, 20, 0, 'Construct a form document.', 0, 7);
INSERT INTO `competencies` VALUES(265, 21, 0, 'Identify the role of design in branding/corporate identity.', 0, 1);
INSERT INTO `competencies` VALUES(266, 21, 0, 'Effectively apply conceptual design skills to develop branding strategies.', 0, 2);
INSERT INTO `competencies` VALUES(267, 21, 0, 'Effectively apply the elements of design to create logos and visual identities.', 0, 3);
INSERT INTO `competencies` VALUES(268, 21, 0, 'Develop information structures that meet client needs for targeted audience.', 0, 4);
INSERT INTO `competencies` VALUES(269, 21, 0, 'Create and present formal project proposals to prospective clients.', 0, 5);
INSERT INTO `competencies` VALUES(270, 21, 0, 'Design and produce identity design for multiple formats including print and web.', 0, 6);
INSERT INTO `competencies` VALUES(274, 22, 0, 'Apply traditional paint concepts, tools, and techniques for use in computer animation.', 0, 1);
INSERT INTO `competencies` VALUES(275, 22, 0, 'Develop critical ideas for surface treatment, lighting, and motion of 3D models.', 0, 2);
INSERT INTO `competencies` VALUES(276, 22, 0, 'Analyze and evaluate and apply texture-mapping strategies.', 0, 3);
INSERT INTO `competencies` VALUES(277, 23, 0, 'Read printed material and summarize, analyze and evaluate information.', 0, 1);
INSERT INTO `competencies` VALUES(278, 23, 0, 'Have an awareness of professional expectations with regards to planning, behavior, communication, and product presentation.', 0, 2);
INSERT INTO `competencies` VALUES(279, 23, 0, 'Know academic and Sacramento culture and apply knowledge to create successful interactions.', 0, 3);
INSERT INTO `competencies` VALUES(280, 23, 0, 'Locate school and community resources.', 0, 4);
INSERT INTO `competencies` VALUES(281, 23, 0, 'Examine our own motivations and learning styles and take appropriate action based on them.', 0, 5);
INSERT INTO `competencies` VALUES(282, 23, 0, 'Articulate the issues that result from living in a diverse world and take action that reflects a respect of differences among human beings.', 0, 6);
INSERT INTO `competencies` VALUES(283, 11, 0, 'Identify websites that demonstrate good layout and usability design techniques.', 0, 1);
INSERT INTO `competencies` VALUES(284, 11, 0, 'Compose basic HTML using a simple text editor.', 0, 2);
INSERT INTO `competencies` VALUES(285, 11, 0, 'Design, produce, and successfully upload a basic website. ', 0, 3);
INSERT INTO `competencies` VALUES(286, 11, 0, 'Construct logical file and directory structures for a website.', 0, 4);
INSERT INTO `competencies` VALUES(287, 11, 0, 'Implement frames, tables and forms using HTML.', 0, 5);
INSERT INTO `competencies` VALUES(288, 11, 0, 'Apply principles of visual design to the layout of web pages.', 0, 6);
INSERT INTO `competencies` VALUES(289, 11, 0, 'Create a proposal and flow chart suitable for delivery to a potential client.', 0, 7);
INSERT INTO `competencies` VALUES(290, 11, 0, 'Apply time and resource management principles to the website production.', 0, 8);
INSERT INTO `competencies` VALUES(291, 11, 0, 'Prepare and use images as effective elements of web design and content.', 0, 9);
INSERT INTO `competencies` VALUES(302, 24, 0, 'Understand the theory behind programming languages versus markup', 0, 1);
INSERT INTO `competencies` VALUES(303, 24, 0, 'Understand the difference between client-side, server-side, server-parsed language', 0, 2);
INSERT INTO `competencies` VALUES(304, 24, 0, 'Understand the differences between procedural and object-oriented programming', 0, 3);
INSERT INTO `competencies` VALUES(305, 24, 0, 'Identify basic data structures (arrays, variables, data types, expressions) ', 0, 4);
INSERT INTO `competencies` VALUES(306, 24, 0, 'Understand DOM object structure of JavaScript in web pages', 0, 5);
INSERT INTO `competencies` VALUES(307, 24, 0, 'Identify the standard set of JavaScript commands and operators', 0, 6);
INSERT INTO `competencies` VALUES(308, 24, 0, 'Understand JavaScript functions and parameter-passing', 0, 7);
INSERT INTO `competencies` VALUES(309, 24, 0, 'Understand event handling within JavaScript', 0, 8);
INSERT INTO `competencies` VALUES(310, 24, 0, 'Acquire and incorporate public JavaScript source code it into programs', 0, 9);
INSERT INTO `competencies` VALUES(311, 24, 0, 'Create a working, original JavaScript program', 0, 10);
INSERT INTO `competencies` VALUES(317, 25, 0, 'Demonstrate an understanding of personal vision as indicated through project work.', 0, 1);
INSERT INTO `competencies` VALUES(318, 25, 0, 'Fully explore the projects at the conceptual level.', 0, 2);
INSERT INTO `competencies` VALUES(319, 25, 0, 'Further refine skills in time and project management.', 0, 3);
INSERT INTO `competencies` VALUES(320, 25, 0, 'Exploration of communicating problems on individual proposals.', 0, 4);
INSERT INTO `competencies` VALUES(321, 25, 0, 'Develop and understanding of integrating their personal vision.', 0, 5);
INSERT INTO `competencies` VALUES(322, 26, 0, 'Apply principles of composition and layout.', 0, 1);
INSERT INTO `competencies` VALUES(323, 26, 0, 'Demonstrate the use of compositional devices such as line, dot, rhythm, values, and contrast.', 0, 2);
INSERT INTO `competencies` VALUES(324, 26, 0, 'Distinguish and apply the principles of grid systems.', 0, 3);
INSERT INTO `competencies` VALUES(325, 26, 0, 'Develop skills and understanding of integration of typography and visuals as well as appropriateness of design intended audience.', 0, 4);
INSERT INTO `competencies` VALUES(326, 26, 0, 'Develop ability to use reference and find research material.', 0, 5);
INSERT INTO `competencies` VALUES(327, 26, 0, 'Develop a working knowledge of layout elements including hierarchy, grid systems, typography, and conceptualization.', 0, 6);
INSERT INTO `competencies` VALUES(328, 27, 0, 'Assess your own current skills and design tasks accordingly.', 0, 1);
INSERT INTO `competencies` VALUES(329, 27, 0, 'Work independently from proposal to final execution.', 0, 2);
INSERT INTO `competencies` VALUES(330, 27, 0, 'Develop an understanding of integrating their personal vision with the design problem.', 0, 3);
INSERT INTO `competencies` VALUES(331, 27, 0, 'Develop an understanding of time management and conceptual thinking.', 0, 4);
INSERT INTO `competencies` VALUES(332, 27, 0, 'Demonstrate the ability to self-direct, time manage, analyze and present your project goals and progress.', 0, 5);
INSERT INTO `competencies` VALUES(333, 27, 0, 'Confront and remedy design problems.', 0, 6);
INSERT INTO `competencies` VALUES(334, 27, 0, 'Identify, analyze, and prioritize problems.', 0, 7);
INSERT INTO `competencies` VALUES(335, 27, 0, 'Apply logical design valuation.', 0, 8);
INSERT INTO `competencies` VALUES(336, 27, 0, 'Use of the correct computer programs is required for all project applications.', 0, 9);
INSERT INTO `competencies` VALUES(337, 28, 0, 'Recognize the difference between 2-D and 3-D design.', 0, 1);
INSERT INTO `competencies` VALUES(338, 28, 0, 'Translate 2-D design into 3-D design.', 0, 2);
INSERT INTO `competencies` VALUES(339, 28, 0, 'Demonstrate translation of 3-D form into 2-D drawings.', 0, 3);
INSERT INTO `competencies` VALUES(340, 28, 0, 'Explore 3-D media to move through visual space.', 0, 4);
INSERT INTO `competencies` VALUES(341, 28, 0, 'Recognize and incorporate function as it relates to design.', 0, 5);
INSERT INTO `competencies` VALUES(342, 28, 0, 'Objectively evaluate function as it pertains to form within basic design.', 0, 6);
INSERT INTO `competencies` VALUES(343, 28, 0, 'Demonstrate construction skills of 3-D projects (structural integrity).', 0, 7);
INSERT INTO `competencies` VALUES(344, 28, 0, 'Develop perceptual and spatial relationships.', 0, 8);
INSERT INTO `competencies` VALUES(345, 28, 0, 'Recognize the qualities shared between two + three dimensional design unique to the space around them.', 0, 9);
INSERT INTO `competencies` VALUES(346, 29, 0, 'Apply principles of composition and design.', 0, 1);
INSERT INTO `competencies` VALUES(347, 29, 0, 'Integrate design concepts, materials, and skills.', 0, 2);
INSERT INTO `competencies` VALUES(348, 29, 0, 'Apply the design process to specific goal-focused problem solving.', 0, 3);
INSERT INTO `competencies` VALUES(349, 29, 0, 'Explore nontraditional design options.', 0, 4);
INSERT INTO `competencies` VALUES(350, 29, 0, 'Develop an understanding of semiotics with the denotation/connotation of images as they exist separately or together.', 0, 5);
INSERT INTO `competencies` VALUES(351, 29, 0, 'Develop an understanding of how messages can be constructed through images, using subject matter, context, juxtaposition, editing, scale, and color to determine the degree of communication.', 0, 6);
INSERT INTO `competencies` VALUES(352, 29, 0, 'Identify and use appropriate research methods.', 0, 7);
INSERT INTO `competencies` VALUES(353, 29, 0, 'Verify that outcomes meet design objectives.', 0, 8);
INSERT INTO `competencies` VALUES(354, 30, 0, 'Acquire an in depth knowledge of the major movements in design and architecture, and be able to identify all major styles and trends.', 0, 1);
INSERT INTO `competencies` VALUES(355, 30, 0, 'Identify the main visual characteristics of a variety of graphic areas in history, including type faces, logos, logotype, borders, and other embellishment devices, and apply these to assignment solutions.', 0, 2);
INSERT INTO `competencies` VALUES(356, 30, 0, 'Gain an understanding of appreciation and be able to recognize outstanding designers.', 0, 3);
INSERT INTO `competencies` VALUES(357, 30, 0, 'Recognize and describe the areas of significant historic interest to the graphic design field in western and other cultures (i.e., Arts and Crafts, Nouveau, Deco, Modernism, Russian Constructivism, etc.).', 0, 4);
INSERT INTO `competencies` VALUES(358, 30, 0, 'Recognize the influence of social and political trends on design; to comprehend the relationship between design and technology.', 0, 5);
INSERT INTO `competencies` VALUES(359, 30, 0, 'Learn to think, research, and present like a designer.', 0, 6);
INSERT INTO `competencies` VALUES(360, 31, 0, 'Develop a basic understanding of semiotics with the denotation/connotation of images as they exist separately or together. ', 0, 1);
INSERT INTO `competencies` VALUES(361, 31, 0, 'Apply the design process to specific goal-focused problem solving.', 0, 2);
INSERT INTO `competencies` VALUES(362, 31, 0, 'Explore nontraditional design options.', 0, 3);
INSERT INTO `competencies` VALUES(363, 31, 0, 'Develop a basic understanding of how messages can be constructed through images, using subject matter, context, juxtaposition, editing, scale, and color to determine the degree of communication.', 0, 4);
INSERT INTO `competencies` VALUES(364, 31, 0, 'Analyze and define creative challenges in message making.', 0, 5);
INSERT INTO `competencies` VALUES(365, 32, 0, 'Participate as a member or leader of a team.', 0, 1);
INSERT INTO `competencies` VALUES(366, 32, 0, 'Assess skills of team members and assign tasks accordingly.', 0, 2);
INSERT INTO `competencies` VALUES(367, 32, 0, 'Set goals for team.', 0, 3);
INSERT INTO `competencies` VALUES(368, 32, 0, 'Describe the dynamics of an effective team.', 0, 4);
INSERT INTO `competencies` VALUES(369, 32, 0, 'Construct team based on knowledge of skill sets.', 0, 5);
INSERT INTO `competencies` VALUES(370, 32, 0, 'Develop client relations and the fundamentals of design as a business - NON PROFIT.', 0, 6);
INSERT INTO `competencies` VALUES(371, 32, 0, 'Develop practical skills in design, scheduling, budgeting, art direction, print production, and project documentation.', 0, 7);
INSERT INTO `competencies` VALUES(372, 33, 0, 'Participate as a member or leader of a team.', 0, 1);
INSERT INTO `competencies` VALUES(373, 33, 0, 'Assess skills of team members and assign tasks accordingly.', 0, 2);
INSERT INTO `competencies` VALUES(374, 33, 0, 'Set goals for team.', 0, 3);
INSERT INTO `competencies` VALUES(375, 33, 0, 'Describe the dynamics of an effective team.', 0, 4);
INSERT INTO `competencies` VALUES(376, 33, 0, 'Construct team based on knowledge of skill sets.', 0, 5);
INSERT INTO `competencies` VALUES(377, 33, 0, 'Develop client relations and the fundamentals of design as a business - NON PROFIT.', 0, 6);
INSERT INTO `competencies` VALUES(378, 33, 0, 'Develop practical skills in design, scheduling, budgeting, art direction, print production, and project documentation.', 0, 7);
INSERT INTO `competencies` VALUES(379, 34, 0, 'Effectively use a page layout software program to graphically create a single and multi-page document.', 0, 1);
INSERT INTO `competencies` VALUES(380, 34, 0, 'Effectively apply typographic principles to documents produced in an electronic environment. ', 0, 2);
INSERT INTO `competencies` VALUES(381, 34, 0, 'Create professionally acceptable layouts for subsequent electronic application.', 0, 3);
INSERT INTO `competencies` VALUES(382, 34, 0, 'Import and manipulate data from other graphics software as part of the final graphics assembly.', 0, 4);
INSERT INTO `competencies` VALUES(383, 34, 0, 'Develop and use a grid structure that will organize type, images and graphic elements for a successful layout.', 0, 5);
INSERT INTO `competencies` VALUES(384, 34, 0, 'Collect and save documents using appropriate specialized file formats for successful proofing and/or final output at a service bureau or other supplier.', 0, 6);
INSERT INTO `competencies` VALUES(385, 34, 0, 'A comprehensive understanding of the industry standard page layout program.', 0, 7);
INSERT INTO `competencies` VALUES(386, 34, 0, 'Utilize tools effectively.', 0, 8);
INSERT INTO `competencies` VALUES(387, 34, 0, 'Create and modify picture boxes.', 0, 9);
INSERT INTO `competencies` VALUES(388, 34, 0, 'Create and modify text boxes.', 0, 10);
INSERT INTO `competencies` VALUES(389, 34, 0, 'Modify type attributes.', 0, 11);
INSERT INTO `competencies` VALUES(390, 34, 0, 'Utilize paragraph formats and style sheets.', 0, 12);
INSERT INTO `competencies` VALUES(391, 34, 0, 'Understand "Collect for Output" function, updating placed images and the inclusion of fonts and graphics in the transportation of files.', 0, 13);
INSERT INTO `competencies` VALUES(392, 34, 0, 'Print documents correctly and generate color separations.', 0, 14);
INSERT INTO `competencies` VALUES(393, 35, 0, 'Identify communication needs of client and audience.', 0, 1);
INSERT INTO `competencies` VALUES(394, 35, 0, 'Display consideration of physical requirements in relation to space and audience and cost in designing.', 0, 2);
INSERT INTO `competencies` VALUES(395, 35, 0, 'Develop a psychology of proper cognitive responses to images.', 0, 3);
INSERT INTO `competencies` VALUES(396, 35, 0, 'Develop an understanding of Semiotics.', 0, 4);
INSERT INTO `competencies` VALUES(397, 35, 0, 'Examine standardization of mark/logo application in various settings (2D, 3D, Virtual, Web, etc.).', 0, 5);
INSERT INTO `competencies` VALUES(398, 35, 0, 'Render design mark on multiple applications representative of a company/product need.', 0, 6);
INSERT INTO `competencies` VALUES(399, 35, 0, 'Relate history and psychology of corporate identity to given projects.', 0, 7);
INSERT INTO `competencies` VALUES(400, 35, 0, 'Historical overview of Corporate/Brand Identity from Hieroglyphics through Iconography. Family crests through early 20th century Branding.', 0, 8);
INSERT INTO `competencies` VALUES(401, 35, 0, 'Discuss co-branding issues and examples.', 0, 9);
INSERT INTO `competencies` VALUES(402, 35, 0, 'Discuss co-branding issues and examples.', 0, 10);
INSERT INTO `competencies` VALUES(403, 35, 0, 'Review branding terminology.', 0, 11);
INSERT INTO `competencies` VALUES(404, 35, 0, 'Develop a basic understanding of importance of product placement, branded environments, scripted spaces, globalization issues, subversive branding, co-branding, and adaptive branding.', 0, 12);
INSERT INTO `competencies` VALUES(405, 36, 0, 'Apply conventions of given environmental concerns and overall zone demands in design.', 0, 1);
INSERT INTO `competencies` VALUES(406, 36, 0, 'Display consideration of physical requirements in relation to space and audience and cost in designing.', 0, 2);
INSERT INTO `competencies` VALUES(407, 36, 0, 'Develop an understanding of 2-dimensional display vs. information systems.', 0, 3);
INSERT INTO `competencies` VALUES(408, 36, 0, 'Understand the physical characteristics of display typologies as they reveal the values in society that produces them.', 0, 4);
INSERT INTO `competencies` VALUES(409, 36, 0, 'Understand the presentation of ''art'' and ''artifacts'' in the contexts of commercial, educational and domestic spaces.', 0, 5);
INSERT INTO `competencies` VALUES(410, 36, 0, 'Develop an understanding of ''traffic'' flow in a given space or spaces.', 0, 6);
INSERT INTO `competencies` VALUES(411, 37, 0, 'Identify, select, and produce a marketing mix.', 0, 1);
INSERT INTO `competencies` VALUES(412, 37, 0, 'Characterize the strengths and functional value of various communications and advertising media: including print, packaging, P.O.P., billboards, television, broadcast, and the web.', 0, 2);
INSERT INTO `competencies` VALUES(413, 37, 0, 'Determine and suggest an appropriate marketing mix.', 0, 3);
INSERT INTO `competencies` VALUES(414, 37, 0, 'Explore various techniques as they apply to an individual marketing mix.', 0, 4);
INSERT INTO `competencies` VALUES(415, 37, 0, 'Utilize appropriate techniques for a marketing mix.', 0, 5);
INSERT INTO `competencies` VALUES(416, 37, 0, 'Identify, select, and use various media and styles to achieve desired results.', 0, 6);
INSERT INTO `competencies` VALUES(417, 37, 0, 'Define and describe potential medium, such as photography, video, audio, or print.', 0, 7);
INSERT INTO `competencies` VALUES(418, 37, 0, 'Apply the selected media and style to a project solution.', 0, 8);
INSERT INTO `competencies` VALUES(419, 37, 0, 'Explore the relationship between language and image.', 0, 9);
INSERT INTO `competencies` VALUES(420, 37, 0, 'Explore signs as being anything and everything that conveys meaning; words, numbers, symbols, myths, color, sound, movement, body language, expressions, aroma, texture, dance movies. Anything that conveys both information and emotion.', 0, 10);
INSERT INTO `competencies` VALUES(421, 37, 0, 'Develop methods to monitor and recognize local, regional, national and global design styles and trends.', 0, 11);
INSERT INTO `competencies` VALUES(422, 37, 0, 'Develop methods of research, semiotic analysis, methods of application.', 0, 12);
INSERT INTO `competencies` VALUES(423, 37, 0, 'Learn how to develop a marketing plan', 0, 13);
INSERT INTO `competencies` VALUES(424, 38, 0, 'Develop a basic understanding on constructing not just a box but 3D structures.', 0, 1);
INSERT INTO `competencies` VALUES(425, 38, 0, 'Create a graphics standards book for your mark with examples.', 0, 2);
INSERT INTO `competencies` VALUES(426, 38, 0, 'Design an original professional mark for a company or product.', 0, 3);
INSERT INTO `competencies` VALUES(427, 38, 0, 'Develop a basic understanding of Semiotics.', 0, 4);
INSERT INTO `competencies` VALUES(428, 38, 0, 'Produce multifaceted design presentations inclusive of defining target audience, naming product/company.', 0, 5);
INSERT INTO `competencies` VALUES(429, 38, 0, 'Effectively use clay and molding techniques.', 0, 6);
INSERT INTO `competencies` VALUES(430, 38, 0, 'Recommend and apply creative solutions to design problems based on historical models, contemporary trends, and current technology.', 0, 7);
INSERT INTO `competencies` VALUES(431, 38, 0, 'Sketch multiple solutions for package redesign and design projects.', 0, 8);
INSERT INTO `competencies` VALUES(432, 38, 0, 'Produce refined black and white layouts of design solutions.', 0, 9);
INSERT INTO `competencies` VALUES(433, 38, 0, 'Produce sketches and solutions that show conceptual design creativity.', 0, 10);
INSERT INTO `competencies` VALUES(434, 38, 0, 'Discuss co-branding issues and examples.', 0, 11);
INSERT INTO `competencies` VALUES(435, 39, 0, 'Demonstrate an understanding of the history and foundation of letter forms. ', 0, 1);
INSERT INTO `competencies` VALUES(436, 39, 0, 'Distinguish classifications of type families.', 0, 2);
INSERT INTO `competencies` VALUES(437, 39, 0, 'Discuss vocabulary of typography (i.e., Serif and San Serif).', 0, 3);
INSERT INTO `competencies` VALUES(438, 39, 0, 'Utilize basic design principles to create well balanced typographic compositions.', 0, 4);
INSERT INTO `competencies` VALUES(439, 39, 0, 'Differentiate the difference between positive and negative space.', 0, 5);
INSERT INTO `competencies` VALUES(440, 39, 0, 'Compare various methods and choose appropriate solutions to solve design problems.', 0, 6);
INSERT INTO `competencies` VALUES(441, 39, 0, 'Apply typography elements as they relate to various design problems.', 0, 7);
INSERT INTO `competencies` VALUES(442, 39, 0, 'Discuss and define "good type" vs. "bad type."', 0, 8);
INSERT INTO `competencies` VALUES(443, 39, 0, 'Demonstrate lettering skills by hand', 0, 9);
INSERT INTO `competencies` VALUES(444, 40, 0, 'Demonstrate the knowledge of hierarchy and placement of display type, by lines, body copy, images, page numbering, and other elements pertinent to page layout in typography.', 0, 1);
INSERT INTO `competencies` VALUES(445, 40, 0, 'Develop and use a grid structure that will organize type, images and graphic elements for a successful layout.', 0, 2);
INSERT INTO `competencies` VALUES(446, 40, 0, 'Create professionally acceptable pencil and marker layouts for subsequent electronic application.', 0, 3);
INSERT INTO `competencies` VALUES(447, 40, 0, 'Evaluate and discuss electronic visual solutions using graphic design criteria.', 0, 4);
INSERT INTO `competencies` VALUES(448, 40, 0, 'Use page design, digital imaging and illustration computer programs to prepare layouts, composition and comprehensive executions of single and multiple page documents.', 0, 5);
INSERT INTO `competencies` VALUES(449, 40, 0, 'Develop facility in computer type usage and distinguish between traditional and computer based type.', 0, 6);
INSERT INTO `competencies` VALUES(450, 40, 0, 'Import and manipulate data from other graphics software as part of the final graphics assembly.', 0, 7);
INSERT INTO `competencies` VALUES(451, 40, 0, 'Collect and save documents using appropriate specialized file formats for successful proofing and/or final output at a service bureau or other supplier.', 0, 8);
