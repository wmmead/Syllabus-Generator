...
<h4 class="fold">Weekly Activities</h4>
    ...
    <span class="alert"><?php print_holiday($classid, $termstart, "2", $daytwo); ?></span><br />
    <div class="activitycontent">
    ...
    <span class="alert"><?php print_holiday($classid, $termstart, "3", $dayone); ?></span><br />
    <div class="activitycontent">
    ...
    <span class="alert"><?php print_holiday($classid, $termstart, "3", $daytwo); ?></span><br />
    <div class="activitycontent">
    ...
    <span class="alert"><?php print_holiday($classid, $termstart, "4", $dayone); ?></span><br />
    <div class="activitycontent">
    ...
    <span class="alert"><?php print_holiday($classid, $termstart, "4", $daytwo); ?></span><br />
    <div class="activitycontent">
    ...
    <span class="alert"><?php print_holiday($classid, $termstart, "5", $dayone); ?></span><br />
    <div class="activitycontent">
    ...
    <span class="alert"><?php print_holiday($classid, $termstart, "5", $daytwo); ?></span><br />
    <div class="activitycontent">
    ...
    <span class="alert"><?php print_holiday($classid, $termstart, "6", $dayone); ?></span><br />
    <div class="activitycontent">
