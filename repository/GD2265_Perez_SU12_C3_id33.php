...
$docx->addTemplateVariable('AVAILABILITY', 'Wednesday 3-4 pm (room 160), by appointment, by email at aperez@aii.edu NOTE: When emailing me, PLEASE put the following in the subject line â€œGD2265â€ to ensure you receive a reply within 24 hrs. Any email sent Friday past 6 pm or weekend may not recei');
...
<li><span style="font-size: 10pt; font-family: \'Arial Narrow\';">Once in the portal, locate your current classes, click the link "<strong>My Classes</strong>". This button will take you to your eCourses home page where you will see all courses your are enrolled in. To access a specific course, click on the course title</span></li>
</ol>
';
